...
<main class="container-fluid">
  ...
  <div class="row">
    <div class="col pb-5 py-5 h-100" style="max-width:15%; min-width: 200px; background-color:#065D3D;">
      ...
      <div class="row mt-3 px-3">
        <p style="text-decoration: none;"><a href="#" style="color: #ffffff"><i><img src="./img/icon/Crud-cadastro.png" alt="" srcset=""></i>Editar</a></p>
        <hr style="color: #ffffff">
      </div>
      ...
      <section class="container-fluid mt-3">
        ...
        <form action="/atualizar/{{$id}}" method="post">
          ...
          <div class="form-outline mb-4">
            ...
            <input type="text" name="nome" value="{{$nome}}" id="form6Example3 inputChanger" class="form-control" style="background-color: #D9D9D9;" />
          ...
          <div class="row mb-4">
            ...
            <div class="col">
              <div class="form-outline">
                ...
                <input type="number" name="valor" value="{{$valor}}" id="form6Example2 inputChanger" class="form-control" style="background-color: #D9D9D9;" />
              </div>
            </div>
          </div>
